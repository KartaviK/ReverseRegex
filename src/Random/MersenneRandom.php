...
class MersenneRandom implements GeneratorInterface
{
     ...
     * Returns a random number. Depending on the application, you likely don't have to reseed every time as you can
     * simply select a different index from the last seed and get a different number.
     *
     * Note: This has been tweaked for performance. It still generates the same numbers as the original algorithm but
     * it's slightly more complicated because it maintains both speed and elegance. Though not a crucial difference
     * under normal use, on 1 million iterations, re-seeding each time, it will save 5 minutes of time from the original
     * algorithm - at least on my system.
     *
